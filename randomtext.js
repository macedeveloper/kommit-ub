function cockandballs() {
    var messages = [
        ...
        `<span class="ggsans" style="color:#FFCD9C"><i>"Kommit is gay"</i>, idk, sounds very gay"<br>- Ivy (Formerly Sunny)</span>`,
        `<span class="ggsans" style="color:#FFCD9C">"I'M NOT RALSEI !!!<br>BUT I'M ASRIEL !!!"</span>`,
        `<span class="ggsans" style="color:#FFCD9C">"Kommit and uhhh... Idk, I forgot his bf name divorce arc"</span>`,
        `<span class="ggsans" style="color:#fecf1e">"cyberbullying victim since 2024"<br>- aster</span>`,
        `<span class="ggsans" style="color:#FFCD9C">I must going to the fountain... 🐺🥀⛓️💔" - Kris</span>`,
        `<span class="ggsans" style="color:#00FF00">"bitch ahh closet dwelling dumbass :3"</span>`,
        `<span class="ggsans" style="color:#00FF00">*paws at you* "can i have a cigarette"<br>- echo the gangbanger</span>`,
        `<span class="ggsans" style="color:#00FF00">"kommit has five guys on him rn gng"</span>`,
        `<span class="ggsans" style="color:#00FF00">"I'm going to send a cursed italian image if you don't take a bath"</span>`,
        `<span class="ggsans" style="color:#FFCD9C">"Balatro"</span>`,
        `<span class="ggsans" style="color:#00FF00">"seven thousand fucking pidgeons, eat this man !!"</span>`,
        `<span class="ggsans" style="color:#FFCD9C">"My bread burnt :("</span>`,
        `<span class="ggsans" style="color:#fecf1e">"mission successful"<br>"pasta rights revoked"</span>`,
        `<span class="ggsans" style="color:#FFCD9C">"I haven't killed all those children 4 years ago"</span>`,
        `<span class="ggsans" style="color:#00FF00">"I have thirsty babies-"</span>`,
        `<span class="ggsans" style="color:#FFCD9C">"I'LL WATCH AS YOU BLEED"</span>`,
        `<span class="ggsans" style="color:#FFCD9C">"When the dust settles, just you and me remain"</span>`,
        `<span class="ggsans" style="color:#FFCD9C">"Kommit, you're going to employed on my McDonald's"</span>`,
        `komi`,
        `disgrace`,
        ...
        `end rod minecratf 🤤🤤🤤`,
        `those with the ggsans font are guests!! please welcome them and then kick them out. i need them outta here`,
        ...
        `Sdimbt?`,
        `Sybau? 💔`,
        `<span class="winxp">look at how insignificant we are</span>`,
        ...
        `sonazzy is canon`,
        `check out starry's youtube <span class="ggsans" style="color:#ff5300">https://www.youtube.com/@sillystarsters</span> or else im gonna die`,
        `<span class="ggsans" style="color:#ff5300">"lalala ... whats this ? kommit calling himself dumbas ??? that is so WRONG !!! YOU NEED SELF LOVE NOW !!!!"</span>`,
        `<span class="ggsans" style="color:#ff5300">"hey guys im the silly and the star AND IM HACKING THE KOMMITS ACCO-"</span>`,
        `<span class="ggsans" style="color:#fecf1e">"this splashtext section is now property of aster incorporated"</span>`,
        `<span class="ggsans" style="color:#fecf1e">"i see you :)"</span>`,
        `<span class="ggsans" style="color:#fecf1e">"polen might not into space but polen can into hack"</span>`,
        `i have an embarassing amount of femboy drawings`,
        `the drawer is not real.`,
        ...
        `aster dont you fucking dare`,
        `SILKSONG IS REALLLLLL`,
        `mods, burn that guy alive`,
        `the pipeline consumes another`,
        `"your gendered hands mean nothing to me."<br>- a certain guy`,
        `avoid melons at all costs`,
        `termination shock!`,
        `how to write good music: uhhhh umm uhhgghh uuuhmmnn,,`,
        `mods, chinese panda on life support react this man.`,
        `my 24 carat gold labewbew`,
        `obama have dihh`,
        `im gonna keep stealing your ideas aster fuck you`,
        `this is OUR code.`,
        `either online 24/7 or unreachable for weeks`,
        `Greve`,
        `THAT'S IT I'M MINING YOUR WHOLE HOUSE DOWN`,
        `meeting table!`,
        `i can't deny it anymore chat i'm a furry`,
        `"i will- burn my dread"`,
        `"i shall touch the moon, one day"`,
        `"i got blood all over, ashes all over, but it's okay, game's over."`,
        `im porter robinsoning it`,
        `THEY FOUND THE FANFICTION.`,
        `imagine being so nervous that even posting on social media is a struggle haha couldnt be me`,
        `deep blue ultrakill ost :fire: :fire:`,
        `I FUCKING LOVE BLUE`,
        `im shivering as i write this`,
        `Your outie likes listening to music.`,
        `SILKSONG SOON`,
        `zoteboat in 2031`,
        `exit 8`,
        `Don't overlook any anomalies.`,
        `If you find anomalies, turn back immediately.`,
        `loves horror stuff but gets scared easily`,
        `line 672!`
    ];
    //  `text`,
    ...
    //  `<span class="normalfont">NORMALFONT</span>`,
    //  `<span class="winxp">WINDOWSXPFONT</span>`,
    //  `<span class="ggsans" style="color:#FFCD9C">SANSSERIF</span>`,
